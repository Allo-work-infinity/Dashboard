...
<head>
   ...
   <title>Allo work infinity - Modifier un abonnement utilisateur</title>
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-12 col-lg-12">
                ...
                <div class="iq-card-header d-flex justify-content-between">
                    ...
                    <h4 class="card-title">Modifier un abonnement utilisateur</h4>
                    </div>
                    <div class="col-sm-12 col-md-6 text-right">
                    <a href="{{ route('user-subscriptions.index') }}" class="btn btn-secondary">← Retour à la liste</a>
                    </div>
                </div>
                ...
                <div class="iq-card-body">
                    ...
                    <form method="POST" action="{{ route('user-subscriptions.update', $sub) }}" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-row">
                        ...
                        >
                            <option value=""></option>
                            @foreach($users as $u)
                            <option value="{{ $u->id }}" {{ old('user_id', $sub->user_id) == $u->id ? 'selected' : '' }}>
                        ...
                        >
                            <option value=""></option>
                            @foreach($plans as $p)
                            <option value="{{ $p->id }}" {{ old('plan_id', $sub->plan_id) == $p->id ? 'selected' : '' }}>
                                {{ $p->name }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-row">
                        ...
                        >
                            ...
                            <option value="{{ $st }}" {{ old('status', $sub->status) === $st ? 'selected' : '' }}>
                                {{ ucfirst($st) }}
                            </option>
                            @endforeach
                        </select>
                        ...
                        <select
                            ...
                            required
                        >
                            @foreach(\App\Models\UserSubscription::PAYMENT_STATUSES as $pst)
                            <option value="{{ $pst }}" {{ old('payment_status', $sub->payment_status) === $pst ? 'selected' : '' }}>
                                {{ ucfirst($pst) }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-row">
                        ...
                        <input
                            ...
                            value="{{ old('amount_paid', $sub->amount_paid) }}"
                        ...
                        <input
                            ...
                            value="{{ old('payment_method', $sub->payment_method) }}"
                        ...
                        <div class="form-check mt-4">
                            ...
                            {{ old('auto_renewal', $sub->auto_renewal) ? 'checked' : '' }}
                            >
                    ...
                    <div class="form-row">
                        ...
                        <input
                            ...
                            value="{{ old('start_date', optional($sub->start_date)->format('Y-m-d')) }}"
                        >
                        ...
                        <input
                            ...
                            value="{{ old('end_date', optional($sub->end_date)->format('Y-m-d')) }}"
                        >
                    ...
                    <div class="form-row">
                        ...
                        <input
                            ...
                            value="{{ old('payment_id', $sub->payment_id) }}"
                        >
                        ...
                        <input
                            ...
                            value="{{ old('transaction_id', $sub->transaction_id) }}"
                        >
                    ...
                    <form action="{{ route('user-subscriptions.destroy', $sub) }}" method="POST"
                            onsubmit="return confirm('Supprimer cet abonnement ?');" class="mt-2 mt-md-0">
                        @csrf
                        @method('DELETE')
