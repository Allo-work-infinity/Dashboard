...
<head>
   ...
   <title>Allo work infinity - Modifier une entreprise</title>
        ...
        <div class="iq-card">
          <div class="iq-card-header d-flex justify-content-between">
            <div class="iq-header-title">
              <h4 class="card-title">Modifier l’entreprise</h4>
            </div>
          ...
          <div class="iq-card-body">
            ...
            <form method="POST" action="{{ route('companies.update', $company) }}" novalidate>
              @csrf
              @method('PUT')
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  @if($company->logo_url)
                    ...
                    <img src="{{ $company->logo_url }}" alt="Logo" class="mt-1 rounded" style="max-height:60px">
                  @endif
                </div>
              </div>
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input
                    ...
                    value="{{ old('governorate', $company->governorate) }}"
                    maxlength="100"
                  >
                ...
                <div class="form-group col-md-4">
                  ...
                  >
                    @foreach($statuses as $st)
                      <option value="{{ $st }}" {{ old('status', $company->status)===$st ? 'selected' : '' }}>
            ...
            <form action="{{ route('companies.destroy', $company) }}" method="POST" onsubmit="return confirm('Supprimer cette entreprise ?');">
              @csrf
              @method('DELETE')
              <button type="submit" class="btn btn-danger">Supprimer l’entreprise</button>
            </form>
