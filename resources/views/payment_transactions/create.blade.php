...
<head>
   ...
   <title>Allo work infinity - Ajouter une transaction</title>
    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-12 col-lg-12">
            ...
            <div class="iq-card-header d-flex justify-content-between">
                ...
                <h4 class="card-title">Ajouter une transaction</h4>
                </div>
            ...
            <div class="iq-card-body">
                ...
                <form method="POST" action="{{ route('payment-transactions.store') }}" novalidate>
                @csrf
                ...
                <div class="form-row">
                    ...
                    <input
                        ...
                        value="{{ old('konnect_transaction_id') }}"
                    >
                ...
                <div class="form-row">
                    ...
                    @php
                        $defaultStatus = old('status', in_array('pending', $statuses ?? []) ? 'pending' : ($statuses[0] ?? ''));
                    @endphp
                    <select
                        id="status"
                        name="status"
                    ...
                    >
                        ...
                        <option value="{{ $st }}" {{ $defaultStatus === $st ? 'selected' : '' }}>
                            {{ ucfirst($st) }}
                        </option>
                        @endforeach
                    </select>
