...
<head>
   ...
   <title>Allo work infinity - Ajouter une candidature </title>
            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12 col-lg-12">
                    ...
                    <div class="iq-card-header d-flex justify-content-between">
                        ...
                        <h4 class="card-title">Ajouter une candidature</h4>
                        </div>
                    ...
                    <div class="iq-card-body">
                        ...
                        <form method="POST" action="{{ route('job-applications.store') }}" enctype="multipart/form-data" novalidate>
                        @csrf
                        ...
                        <div class="form-row">
                            ...
                            >
                                ...
                                <option value="{{ $st }}" {{ old('status','submitted')===$st ? 'selected' : '' }}>
                            ...
                            <div class="form-group col-md-4">
                            <label for="cv">CV (fichier, optionnel)</label>
                            <input
                                type="file"
                                id="cv"
                                name="cv"
                        ...
                        <div class="form-group">
                            ...
                            >{{ old('additional_documents') }}</textarea>
                        ...
                        <div class="form-row">
                            ...
                            >
                                ...
                                <option value="{{ $r->id }}" {{ old('reviewed_by') == $r->id ? 'selected' : '' }}>
